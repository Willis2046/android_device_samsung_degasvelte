...
TARGET_SPECIFIC_HEADER_PATH := device/samsung/degasvelte/include
...
# Assert
TARGET_OTA_ASSERT_DEVICE := degasvelte

# Audio
BOARD_USES_ALSA_AUDIO := true

# Bluetooth
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/samsung/degasvelte/bluetooth
...
BOARD_EGL_CFG := device/samsung/degasvelte/configs/egl.cfg

# Kernel
TARGET_KERNEL_SOURCE := kernel/samsung/degasvelte
TARGET_KERNEL_CONFIG := pxa1908_degasvelte_eur_defconfig
BOARD_KERNEL_BASE := 0x10000000
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/degasvelte/degasvelte_mkbootimg.mk
BOARD_MKBOOTIMG_ARGS := --dt device/samsung/degasvelte/rootdir/boot.img-dt --ramdisk_offset 0x01000000
BOARD_KERNEL_PAGESIZE := 2112
...
# Recovery
TARGET_RECOVERY_FSTAB := device/samsung/degasvelte/rootdir/fstab.pxa1908
